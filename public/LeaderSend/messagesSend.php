...
<table class="head-wrap" bgcolor="#fff">
	<tr>
		...
		<td class="header container" >
				...
				<table bgcolor="#fff">
					<tr>
						<td><img src="http://www.dinedesk.com/ddstyles/images/DineDesk_logo.png" /></td>
						<td align="right"><h6 class="collapse">Test Email</h6></td>
					</tr>
				</table>
				</div>
...
$request = array(
	'subject' => 'A little bit of this, A little bit of that & a whole of Xmas', // required
	'from'    => array( // required. A sender’s information
		'name'  => 'Roshni',
		'email' => 'emails@dinedesk.com'
	),
