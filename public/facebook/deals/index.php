...
if($restID == ""){
	...
	$app_id = "583070501726996";
	$app_secret = "909f0c49441d815b46d65cce6790c555";
	...
	$signed_request = $_REQUEST["signed_request"];
		 ...
		 $file = fopen("http://www.dinedesk.com/FirmManagement/Firm/firmdetailsbydealsocialid/fbpageid/".$page_id, "r");
	...
	//restID value from database query needs to be added to end of canvas_page url below.  Also URL should be update to the location of the this index.php on urserv.com
		 $canvas_page = "http://www.dinedesk.com/facebook/deals/index.php?restID=".$restID;
...
if($restID != ""){?>
	<iframe src="https://www.dinedesk.com/index.php/Reservation/Reservation/socialdealwidgetviewall/restid/<?php echo $restID; ?>" scrolling="no" frameborder="0" style="overflow:auto; overflow-x:hidden; width:800px; height:620px;" allowTransparency="true"></iframe>
<p>&nbsp;</p>
<?php }else{
