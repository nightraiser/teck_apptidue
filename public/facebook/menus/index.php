...
if($restID == ""){
	...
	$signed_request = $_REQUEST["signed_request"];
		 ...
		 $file = fopen("http://www.dinedesk.com/FirmManagement/Firm/firmdetailsbymenusocialid/fbpageid/".$page_id, "r");
	...
	//restID value from database query needs to be added to end of canvas_page url below.  Also URL should be update to the location of the this index.php on urserv.com
		 $canvas_page = "http://www.dinedesk.com/facebook/menus/index.php?restID=".$restID;
...
if($restID != ""){?>
	<iframe src="https://www.dinedesk.com/index.php/FirmManagement/Firm/socialfirmcuisines/restaurantid/<?php echo $restID; ?>" scrolling="no" frameborder="0" style="overflow:hidden; width:800px; height:615px;" allowTransparency="true"></iframe>
<p>&nbsp;</p>
<?php }else{
