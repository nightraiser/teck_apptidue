...
if($restID == ""){
	...
	$signed_request = $_REQUEST["signed_request"];
		 ...
		 $file = fopen("http://www.dinedesk.com/FirmManagement/Firm/restaurantinfobyfbinquirypageid/fbpageid/".$page_id, "r");
...
if($restID != ""){?>
	<iframe src="https://www.dinedesk.com/index.php/Reservation/Reservation/dealwidgetviewall/restid/<?php echo $restID; ?>" scrolling="no" frameborder="0" style="overflow:auto; overflow-x:hidden; width:800px; height:620px;" allowTransparency="true"></iframe>
<p>&nbsp;</p>
<?php }else{
