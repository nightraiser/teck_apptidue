...
function createHomepageGoogleMap(_latitude,_longitude,json){
  ...
  //  var boudaries_json = [(17.3983126311485,78.49340915679932),(17.395609783785783,78.49053382873535),(17.39110494941309,78.48907470703125),(17.388197224677164,78.48718643188477),(17.38700954916837,78.48637104034424),(17.38520754401984,78.487229347229),(17.384347489852328,78.4903621673584),(17.38225877004684,78.49122047424316),(17.38098914439931,78.4918212890625),(17.382013036737845,78.49319458007812),(17.383815073342124,78.49701404571533),(17.385699001729336,78.49946022033691),(17.387623865049225,78.50237846374512),(17.38938489247641,78.50456714630127),(17.390183490612642,78.50405216198305),(17.390982088739666,78.50465297698975),(17.392374499285875,78.50424528206031),(17.393848816285235,78.50443840026855),(17.394749778520094,78.50259304046631),(17.395241210595692,78.50156307220459),(17.39462692029487,78.49963188171387),(17.394749778520094,78.49873065948486),(17.395364068408263,78.49774360656738),(17.396633594305186,78.49594116210938)];
  //  console.log(boudaries_json);
            ...
            '<div class="inner">' +
                '<div class="image">' +
                    ...
                    '<div class="item-specific">' +
                        '<span title="Bedrooms"><img src="/images/bedrooms.png">' + json.data[i].bedrooms + '</span>' +
                        '<span title="Bathrooms"><img src="/images/bathrooms.png">' + json.data[i].bathrooms + '</span>' +
                        '<span title="Area"><img src="/images/area.png">' + json.data[i].area + '<sup>2</sup></span>' +
                        '<span title="Garages"><img src="/images/garages.png">' + json.data[i].garages + '</span>' +
                    '</div>' +
                    '<div class="overlay">' +
                        '<div class="wrapper">' +
    ...
    function drawItemSpecific(category){
        if( category ){
            if( category == 'real_estate' ){
                var itemSpecific =
                '<div class="item-specific">' +
                    '<span title="Bedrooms"><img src="/images/bedrooms.png">' + json.data[a].bedrooms + '</span>' +
                    '<span title="Bathrooms"><img src="/images/bathrooms.png">' + json.data[a].bathrooms + '</span>' +
                    '<span title="Area"><img src="/images/area.png">' + json.data[a].area + '<sup>2</sup></span>' +
                    '<span title="Garages"><img src="/images/garages.png">' + json.data[a].garages + '</span>' +
                '</div>';
                return itemSpecific;
            }
            else if ( category == 'bar_restaurant' ){
            ...
            '<div class="modal-dialog">' +
                '<div class="modal-content">' +
                    '<div class="modal-header">' +
                        '<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true"><img src="/images/close.png"></span></button>' +
                        '<div class="left">' +
